...
// // gsap.timeline({
// //   scrollTrigger: {
// //     trigger: ".text-with-head",
// //     start: "top bottom",
// //     end: "center center",
// //     scrub: true,
// //     markers:true,
// //       toggleClass: {targets: ".text-with-images-blocks-section-1", class: "active"} 

// //   }
// // })
// // .to(".text-with-images-blocks-section-1 span:nth-child(1)",  { x:0, y: 0, autoAlpha:1 }, 0.1)
// // .to(".text-with-images-blocks-section-1 span:nth-child(2)", { x:0, y:  0, autoAlpha:1 }, 0.2)
// // .to(".text-with-images-blocks-section-1 span:nth-child(3)", { x:0, y: 0, autoAlpha:1 }, 0.3)
// // .to(".text-with-images-blocks-section-1 span:nth-child(4)",   { x:0, y:  0, autoAlpha:1 }, 0.4);

// ScrollTrigger.create({
//    trigger: ".text-with-head",
//   // markers: true,
//       start: "top bottom",
//   toggleClass: {targets: ".text-with-images-blocks-section-1", className: "active"} 
// });
// ScrollTrigger.create({
//    trigger: ".images-wrapper-here",
//   // markers: true,
//       start: "top bottom",
//   toggleClass: {targets: ".images-wrapper-here", className: "active"} 
// });
// ScrollTrigger.create({
//    trigger: ".text-image-button",
//   // markers: true,
//       start: "center center",
//   toggleClass: {targets: ".text-image-button", className: "active"} 
// });
window.onload = function(e){ 

var style = document.createElement( 'style' )
style.innerHTML = `span#shopify-installments-content { font-family: 'Suisse Intl'; font-style: normal; font-weight: 500; font-size: 15px; line-height: 111%; /* identical to box height, or 17px */ letter-spacing: -0.02em; color: rgba(0, 0, 0, 0.29); } p#shopify-installments { font-family: 'Suisse Intl'; font-style: normal; font-weight: 500; font-size: 15px; line-height: 111%; /* identical to box height, or 17px */ letter-spacing: -0.02em; color: rgba(0, 0, 0, 0.29); }@media only screen and (max-width:749px){span#shopify-installments-content,.shopify-installments__learn-more { font-size: 12px; line-height: 121%; }}`;
document.querySelector('shopify-payment-terms').shadowRoot.appendChild( style )
}
$(document).ready(function() {
           $('.template-index').css('opacity','1');
  if($('.newsletter-section .note--success').length){
   $('#NewsletterPopup-newsletter-popup').addClass('hide-popup');
    $('#offer-popup').addClass('modal');
}
});

$('.close-success-popup').click(function() {
    $('.template-index .newsletter-section .note--success').hide();
     $('html').removeClass('modal-open');
     $('#offer-popup').removeClass('modal');
     
});


$('.shoppay-open').click(function() {
     $('html').addClass('modal-open');
     $('.popup-wraper').addClass('modal');
});

$('.close-shoppay-popup').click(function() {
     $('html').removeClass('modal-open');
     $('.popup-wraper').removeClass('modal');
