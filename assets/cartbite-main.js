if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BBXYjP8rgXi7mJKkg9vs2bvOeunChzoODBjxUatytopw5WTiYRj5yrE1IKNVsmr9_3SvrVvpXrFemZLZfJ_al68",
    clientId: "ISKE2WGR1UWM6XZFUIQKVZKX",
    ...
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: 'LYGWLP18LHCWBLBJUD6FQ2FX'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: '1VQ6EWEI3IGEDWFIXBMZQQP1'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: '9WTC5DGGUVFCFZRC4JU99I79'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'XN1MAKXBZHDDF584HA1FDQ7Z',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'C5C6H3C2HYN4S82EDHLYE411',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: 'NTRHTFB4DL9H5X93F61M65WG',
    },
    stockWidget: {
      ...
      textColor: "#ffffff",
      subscriptionText: "COMING SOON - JOIN THE WAITLIST",
      subscribedText: "❤️",
      modalHtml: `<html>
<head>
...
<div class="modal" v-cloak id="el">
  <div class="modal-container">
    ...
    <p class="notification-message">We're so excited you've got your eyes on our shoes! To honor their patience, early waitlist members will have first dibs on the restock. Join the list for updates on availability and stay tuned for some big announcements coming soon! 🔥🔥</p>
    ...
    <div v-if="dataEntered" class="gw-success-message alert alert-success complete"> Awesome! You're on the list. Stay tuned for updates and keep an eye out for some exciting news.
      <a href="#"
         class="action-close"
    ...
    <div class="marketing-container" v-if="shopifyMailingListEnabled">
      ...
      <label class="marketing-container-label" for="accepts_marketing">Receive exclusive Forgano updates</label>
    </div>
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        heading: "heading",
        subheading: "We're so excited you've got your eyes on our shoes! To honor their patience, early waitlist members will have first dibs on the restock. Join the list for updates on availability and stay tuned for some big announcements coming soon! 🔥🔥",
        notifyButtonTitle: "Get Notified",
        privacyText: "We respect your privacy and do not share your email with anyone.",
        emailWorkflowUniqueId: "1VQ6EWEI3IGEDWFIXBMZQQP1",
        smsWorkflowUniqueId: "9WTC5DGGUVFCFZRC4JU99I79",
        successText: "Awesome! You're on the list. Stay tuned for updates and keep an eye out for some exciting news.",
        successCloseText: "Close",
        optInMarketingText: "Receive exclusive Forgano updates",
        email: "",
        phoneNumber: '',
...
`,
    ...
    customJs: `let insertAfterEle=document.querySelector(".custom-quantity_selector_wrapper");
